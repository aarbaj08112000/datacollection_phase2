...
<div class="">
    <div class="">
        <div class=" w-100">
         ...
         <div class="">
                <form action="<%base_url()%>submit_edit_form" method="POST" class="container mt-4 custom-form submit_form" id="submit_form">
                            ...
                            <%if $field['field_data']['form_type'] eq 'input'%>
                                <div class="col-md-4 form-group mb-3">
                                    ...
                                    placeholder="Enter <%strtolower($field['field_data']['form_title'])%>" 
                                     value="<%$form_values[$field['field_data']['form_name']]%>">
                                    <%if $field['field_data']['prefix'] != ""%>
                                       </div>
                                        </div>
                                    <%/if%>
                                ...
                                <div class="col-md-4 form-group mb-3">
                                    ...
                                    <div class="radio-option">
                                        ...
                                        <div class="form-check form-check-inline mt-2">
                                          <input class="form-check-input <%if $field['required'] eq 'Yes'%>required-input<%else%>required-input-not<%/if%>" type="radio" name="<%$field['field_data']['form_name']%>"  value="<%trim($values)%>" <%if $form_values[$field['field_data']['form_name']] eq trim($values)%> checked<%/if%>>
                            ...
                            <%else if $field['field_data']['form_type'] eq 'drop_down'%>
                                <div class="col-md-4 form-group mb-3">
                                    ...
                                    <div class="radio-option">
                                        ...
                                        <%foreach from=$field['field_data']['form_value'] key=key item="values"%>
                                        <option value="<%trim($values)%>" <%if $form_values[$field['field_data']['form_name']] eq trim($values)%>selected<%/if%>><%$values%></option>
                                        <%/foreach%>
                                        </select>
                                    </div>
                                </div>
